...
class buildings(models.Model):
    ...
    producton_magical_creatures = fields.Integer(related = 'building_type.production_magical_creatures')
    producton_warrior_creatures = fields.Integer(related = 'building_type.production_warrior_creatures')
    producton_defense_creatures = fields.Integer(related = 'building_type.production_defense_creatures')
