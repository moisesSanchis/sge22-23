...
class buildings(models.Model):
    ...
    production_iron = fields.Integer(related = 'building_type.production_iron')
    production_coal = fields.Integer(related = 'building_type.production_coal')
    production_steel = fields.Integer(related = 'building_type.production_steel')
    consume_iron = fields.Integer(related = 'building_type.consume_iron')
    consume_coal = fields.Integer(related = 'building_type.consume_coal')
    production_magical_creatures = fields.Integer(related = 'building_type.production_magical_creatures')
    production_warrior_creatures = fields.Integer(related = 'building_type.production_warrior_creatures')
    production_defense_creatures = fields.Integer(related = 'building_type.production_defense_creatures')
...
class building_type(models.Model):
    ...
    production_magical_creatures = fields.Integer()
    production_warrior_creatures = fields.Integer()
    production_defense_creatures = fields.Integer()
