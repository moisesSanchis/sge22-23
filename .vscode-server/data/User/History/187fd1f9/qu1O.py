...
class buildings(models.Model):
    ...
    production_iron = fields.Integer(related = 'bulding_type.production_iron')
    production_coal = fields.Integer(related = 'bulding_type.production_coal')
    production_steel = fields.Integer(related = 'bulding_type.production_steel')
    consume_iron = fields.Integer(related = 'bulding_type.consume_iron')
    consume_coal = fields.Integer(related = 'bulding_type.consume_coal')
    producton_magical_creatures = fields.Integer(related = 'bulding_type.production_magical_creatures')
    producton_warrior_creatures = fields.Integer(related = 'bulding_type.production_warrior_creatures')
    producton_defense_creatures = fields.Integer(related = 'bulding_type.production_defense_creatures')
